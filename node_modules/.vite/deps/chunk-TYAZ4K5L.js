...
function $4d52238874b24f86$export$9bb30bbe003b82e0(props, state, inputRef) {
  ...
  let onKeyDown = (e2) => {
    ...
    if (key === "Escape") {
      if (state.value === "" && (!inputRef.current || inputRef.current.value === "")) e2.continuePropagation();
      else {
        e2.preventDefault();
        state.setValue("");
        if (onClear) onClear();
...
function $6e31608fbba75bab$export$25bceaac3c7e4dc7(props, state, ref) {
  ...
  let sortDescription = (0, import_react2.useMemo)(() => {
    ...
    let columnName = (_state_collection_columns_find_textValue = (_state_collection_columns_find = state.collection.columns.find((c3) => c3.key === column)) === null || _state_collection_columns_find === void 0 ? void 0 : _state_collection_columns_find.textValue) !== null && _state_collection_columns_find_textValue !== void 0 ? _state_collection_columns_find_textValue : "";
...
function $e91ef4e5004e3774$export$52994e973806c219(props, state, ref) {
  ...
  let onKeyDown = (0, import_react4.useCallback)((e2) => {
    ...
    if (editModeEnabled) (_moveProps_onKeyDown = moveProps.onKeyDown) === null || _moveProps_onKeyDown === void 0 ? void 0 : _moveProps_onKeyDown.call(moveProps, e2);
  }, [
    editModeEnabled,
    moveProps
  ]);
...
function InsertionIndicator(props) {
  ...
  return (0, import_jsx_runtime11.jsx)("div", {
    style: {
      left: visibleRect === null || visibleRect === void 0 ? void 0 : visibleRect.x,
      position: "absolute",
      top: rowTop + (target.dropPosition === "after" ? rowHeight : 0),
      width: visibleRect === null || visibleRect === void 0 ? void 0 : visibleRect.width,
      zIndex: 4
    },
    role: "row",
...
var TableViewLayout = class extends $a152112e902709bf$export$62444c3c724b1b20 {
  ...
  getDropTargetFromPoint(x2, y, isValidDropTarget) {
    var _layout$getVisibleLay;
    let headerRowHeight = (_layout$getVisibleLay = this.virtualizer.layout.getVisibleLayoutInfos(new $60423f92c7f9ad87$export$c79fc6492f3af13d(x2, y, 1, 1)).find((info) => info.type === "headerrow")) === null || _layout$getVisibleLay === void 0 ? void 0 : _layout$getVisibleLay.rect.height;
    if (headerRowHeight) {
      y -= headerRowHeight;
    }
...
function TableRow(props) {
  var _state$collection$row, _draggableItem, _draggableItem2, _dragAndDropHooks$isV4, _droppableItem, _droppableItem2, _layout$virtualizer, _dropIndicator, _dropIndicator2, _layout$virtualizer2;
  let {
    item,
    children,
    layoutInfo,
  ...
  if (isLastRow) {
    var _layout$getContentSiz;
    if (layout.virtualizer && ((_layout$getContentSiz = layout.getContentSize()) === null || _layout$getContentSiz === void 0 ? void 0 : _layout$getContentSiz.height) >= layout.virtualizer.visibleRect.height) {
  ...
  return (0, import_jsx_runtime11.jsxs)(TableRowContext.Provider, {
    ...
    children: [isTableDroppable && isFirstRow && (0, import_jsx_runtime11.jsx)(InsertionIndicator, {
      ...
      visibleRect: (_layout$virtualizer = layout.virtualizer) === null || _layout$virtualizer === void 0 ? void 0 : _layout$virtualizer.visibleRect,
      target: {
        key: item.key,
        type: "item",
        dropPosition: "before"
...
function TableCellWrapper(props) {
  ...
  if (isTableDroppable) {
    var _parent$content;
    assert(!!dropState);
    let key = (_parent$content = parent.content) === null || _parent$content === void 0 ? void 0 : _parent$content.key;
    if (key) {
...
var clipboardPasteIcon = (0, import_jsx_runtime16.jsxs)(import_jsx_runtime16.Fragment, {
  children: [(0, import_jsx_runtime16.jsx)("path", {
    d: "M15 2H9a1 1 0 0 0-1 1v2c0 .6.4 1 1 1h6c.6 0 1-.4 1-1V3c0-.6-.4-1-1-1"
...
var cacheExchange = (e2) => ({ forward: t, client: i, dispatchDebug: n }) => {
  ...
  return (e3) => {
    ...
    var m3 = map2((e4) => {
      ...
      return addMetadata(e4.operation, {
        cacheOutcome: "miss"
      });
    ...
    var N3 = map2((e4) => {
      ...
      var s, l;
      var v = {
        operation: addMetadata(e4.operation, {
...
*/
//# sourceMappingURL=chunk-TYAZ4K5L.js.map
